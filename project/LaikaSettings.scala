...
object LaikaSettings {
  ...
  object versions {
    ...
    val v04:     Version      = version(LdbcVersions.v04, "Stable")
    val v05:     Version      = version(LdbcVersions.latest, "Dev")
    val current: Version      = v05
    val all:     Seq[Version] = Seq(v05, v04, v03, v02)
