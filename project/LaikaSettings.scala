...
object LaikaSettings {
  ...
  object versions {
    ...
    val v03:     Version      = version(LdbcVersions.v03)
    ...
    val v08:     Version      = version(LdbcVersions.v08)
    val v09:     Version      = version(LdbcVersions.latest, "Stable")
    val current: Version      = v09
    val all:     Seq[Version] = Seq(v09, v08, v07, v06, v05, v04, v03, v02)
