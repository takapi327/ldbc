...
object Collate:
  ...
  def Armscii8GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("armscii8_general_ci", Character.Armscii8, 32, true, true, 1)

  def AsciiBin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("ascii_bin", Character.Ascii, 65, false, true, 1)
  def AsciiGeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("ascii_general_ci", Character.Ascii, 11, true, true, 1)
  ...
  def CP1250CroatianCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1250_croatian_ci", Character.CP1250, 44, false, true, 1)
  def CP1250CzechCs[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1250_czech_cs", Character.CP1250, 34, false, true, 2)
  def CP1250GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1250_general_ci", Character.CP1250, 26, true, true, 1)
  def CP1250PolishCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1250_polish_ci", Character.CP1250, 99, false, true, 1)

  def CP1251Bin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1251_bin", Character.CP1251, 50, false, true, 1)
  def CP1251BulgarianCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1251_bulgarian_ci", Character.CP1251, 14, false, true, 1)
  def CP1251GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1251_general_ci", Character.CP1251, 51, true, true, 1)
  def CP1251GeneralCs[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1251_general_cs", Character.CP1251, 52, false, true, 1)
  def CP1251UkrainianCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1251_ukrainian_ci", Character.CP1251, 23, false, true, 1)

  def CP1256Bin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1256_bin", Character.CP1256, 67, false, true, 1)
  def CP1256GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1256_general_ci", Character.CP1256, 57, true, true, 1)

  def CP1257Bin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1257_bin", Character.CP1257, 58, false, true, 1)
  def CP1257GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1257_general_ci", Character.CP1257, 59, true, true, 1)
  def CP1257LithuanianCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp1257_lithuanian_ci", Character.CP1257, 29, false, true, 1)

  def CP850Bin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp850_bin", Character.CP850, 80, false, true, 1)
  def CP850GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp850_general_ci", Character.CP850, 4, true, true, 1)

  def CP852Bin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp852_bin", Character.CP852, 81, false, true, 1)
  def CP852GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp852_general_ci", Character.CP852, 40, true, true, 1)

  def CP866Bin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp866_bin", Character.CP866, 68, false, true, 1)
  def CP866GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp866_general_ci", Character.CP866, 36, true, true, 1)

  def CP932Bin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp932_bin", Character.CP932, 96, false, true, 1)
  def CP932JapaneseCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("cp932_japanese_ci", Character.CP932, 95, true, true, 1)
  ...
  def EucjpmsJapaneseCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("eucjpms_japanese_ci", Character.Eucjpms, 97, true, true, 1)
  ...
  def GB18030ChineseXU[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("gb18030_chinese_ci", Character.GB18030, 248, true, true, 1)
  def GB18030uUnicode520CI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("gb18030_unicode_520_ci", Character.GB18030, 250, false, true, 1)

  def GB2312Bin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("gb2312_bin", Character.GB18030, 86, false, true, 1)
  def GB2312ChineseCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("gb2312_chinese_ci", Character.GB18030, 24, true, true, 1)
  ...
  def Geostd8GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("geostd8_general_ci", Character.Geostd8, 92, true, true, 1)

  def GreekBin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("greek_bin", Character.Greek, 70, false, true, 1)
  def GreekGeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("greek_general_ci", Character.Greek, 25, true, true, 1)

  def HebrewBin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("hebrew_bin", Character.Hebrew, 71, false, true, 1)
  def HebrewGeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("hebrew_general_ci", Character.Hebrew, 16, true, true, 1)
  ...
  def Keybcs2GeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("keybcs2_general_ci", Character.Keybcs2, 37, true, true, 1)

  def Koi8rBin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("koi8r_bin", Character.Koi8r, 74, false, true, 1)
  def Koi8rGeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("koi8r_general_ci", Character.Koi8r, 7, true, true, 1)

  def Koi8uBin[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("koi8u_bin", Character.Koi8u, 75, false, true, 1)
  def Koi8uGeneralCI[T <: COLLATION_TYPE]: Collate[T] = Collate[T]("koi8u_general_ci", Character.Koi8u, 22, true, true, 1)
