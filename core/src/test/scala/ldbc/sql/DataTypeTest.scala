  ...
  "DataType Test" should {
    ...
    "The query string generated from the Tinyint DataType model matches the specified one." in {
      Tinyint[Byte](1, None).queryString === "TINYINT(1) NOT NULL" and
        ...
        TinyintOpt[Option[Byte]](64, None).DEFAULT("byte".getBytes.headOption).queryString === "TINYINT(64) NULL DEFAULT '98'" and
    ...
    "The query string generated from the Decimal DataType model matches the specified one." in {
      Decimal[BigDecimal](10, 7, None).queryString === "DECIMAL(10, 7) NOT NULL" and
        Decimal[BigDecimal](10, 7, None).DEFAULT(BigDecimal(10, 7)).queryString === "DECIMAL(10, 7) NOT NULL DEFAULT '0.0000010'" and
        ...
        DecimalOpt[Option[BigDecimal]](10, 7, None).DEFAULT(Some(BigDecimal(10, 7))).queryString === "DECIMAL(10, 7) NULL DEFAULT '0.0000010'" and
    ...
    "The query string generated from the Char DataType model matches the specified one." in {
      CChar[String](0, None).queryString === "CHAR(0) NOT NULL" and
        CChar[String](0, None).DEFAULT("test").queryString === "CHAR(0) NOT NULL DEFAULT 'test'" and
        CharOpt[Option[String]](0, None).queryString === "CHAR(0) NULL" and
        CharOpt[Option[String]](0, None).DEFAULT(None).queryString === "CHAR(0) NULL DEFAULT NULL" and
        CharOpt[Option[String]](0, None).DEFAULT(Some("test")).queryString === "CHAR(0) NULL DEFAULT 'test'" and
        CharOpt[Option[String]](0, None).DEFAULT_NULL.queryString === "CHAR(0) NULL DEFAULT NULL"
    }

    "The query string generated from the Varchar DataType model matches the specified one." in {
      Varchar[String](0, None).queryString === "VARCHAR(0) NOT NULL" and
        Varchar[String](0, None).DEFAULT("test").queryString === "VARCHAR(0) NOT NULL DEFAULT 'test'" and
        VarcharOpt[Option[String]](0, None).queryString === "VARCHAR(0) NULL" and
        VarcharOpt[Option[String]](0, None).DEFAULT(None).queryString === "VARCHAR(0) NULL DEFAULT NULL" and
        VarcharOpt[Option[String]](0, None).DEFAULT(Some("test")).queryString === "VARCHAR(0) NULL DEFAULT 'test'" and
        VarcharOpt[Option[String]](0, None).DEFAULT_NULL.queryString === "VARCHAR(0) NULL DEFAULT NULL"
    }
    ...
    "The query string generated from the Binary DataType model matches the specified one." in {
      Binary[Array[Byte]](0).queryString === "BINARY(0) NOT NULL" and
        BinaryOpt[Option[Array[Byte]]](0).queryString === "BINARY(0) NULL"
    }
    ...
    "The query string generated from the Varbinary DataType model matches the specified one." in {
      Varbinary[Array[Byte]](0).queryString === "VARBINARY(0) NOT NULL" and
        VarbinaryOpt[Option[Array[Byte]]](0).queryString === "VARBINARY(0) NULL"
    }
    ...
    "The query string generated from the Tinyblob DataType model matches the specified one." in {
      Tinyblob[Array[Byte]]().queryString === "TINYBLOB NOT NULL" and
        TinyblobOpt[Option[Array[Byte]]]().queryString === "TINYBLOB NULL"
    }
    ...
    "The query string generated from the Blob DataType model matches the specified one." in {
      Blob[Array[Byte]](0).queryString === "BLOB(0) NOT NULL" and
        BlobOpt[Option[Array[Byte]]](0).queryString === "BLOB(0) NULL"
    }
    ...
    "The query string generated from the Mediumblob DataType model matches the specified one." in {
      Mediumblob[Array[Byte]]().queryString === "MEDIUMBLOB NOT NULL" and
        MediumblobOpt[Option[Array[Byte]]]().queryString === "MEDIUMBLOB NULL"
    }
    ...
    "The query string generated from the LongBlob DataType model matches the specified one." in {
      LongBlob[Array[Byte]]().queryString === "LONGBLOB NOT NULL" and
        LongBlobOpt[Option[Array[Byte]]]().queryString === "LONGBLOB NULL"
    }
    ...
    "The query string generated from the TinyText DataType model matches the specified one." in {
      TinyText[String]().queryString === "TINYTEXT NOT NULL" and
        TinyTextOpt[Option[String]]().queryString === "TINYTEXT NULL"
    }
    ...
    "The query string generated from the Text DataType model matches the specified one." in {
      Text[String]().queryString === "TEXT NOT NULL" and
        TextOpt[Option[String]]().queryString === "TEXT NULL"
    }
    ...
    "The query string generated from the MediumText DataType model matches the specified one." in {
      MediumText[String]().queryString === "MEDIUMTEXT NOT NULL" and
        MediumTextOpt[Option[String]]().queryString === "MEDIUMTEXT NULL"
    }
    ...
    "The query string generated from the LongText DataType model matches the specified one." in {
      LongText[String]().queryString === "LONGTEXT NOT NULL" and
        LongTextOpt[Option[String]]().queryString === "LONGTEXT NULL"
    }
    ...
    "The query string generated from the Date DataType model matches the specified one." in {
      Date[LocalDate](None).queryString === "DATE NOT NULL" and
        Date[LocalDate](None).DEFAULT(LocalDate.of(2023, 2, 10)).queryString === "DATE NOT NULL DEFAULT '2023-02-10'" and
        ...
        DateOpt[Option[LocalDate]](None).DEFAULT(Some(LocalDate.of(2023, 2, 10))).queryString === "DATE NULL DEFAULT '2023-02-10'" and
    ...
    "The query string generated from the DateTime DataType model matches the specified one." in {
      DateTime[LocalDateTime](None).queryString === "DATETIME NOT NULL" and
        DateTime[LocalDateTime](None).DEFAULT(LocalDateTime.of(2023, 2, 10, 10, 0)).queryString === "DATETIME NOT NULL DEFAULT '2023-02-10T10:00'" and
        ...
        DateTimeOpt[Option[LocalDateTime]](None).DEFAULT(Some(LocalDateTime.of(2023, 2, 10, 10, 0))).queryString === "DATETIME NULL DEFAULT '2023-02-10T10:00'" and
        DateTimeOpt[Option[LocalDateTime]](None).DEFAULT_NULL.queryString === "DATETIME NULL DEFAULT NULL" and
        DateTimeOpt[Option[LocalDateTime]](None).DEFAULT_CURRENT_TIMESTAMP().queryString === "DATETIME NULL DEFAULT CURRENT_TIMESTAMP" and
        DateTimeOpt[Option[LocalDateTime]](None).DEFAULT_CURRENT_TIMESTAMP(true).queryString === "DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"
    }
    ...
    "The query string generated from the TimeStamp DataType model matches the specified one." in {
      TimeStamp[LocalDateTime](None).queryString === "TIMESTAMP NOT NULL" and
        TimeStamp[LocalDateTime](None).DEFAULT(LocalDateTime.of(2023, 2, 10, 10, 0)).queryString === "TIMESTAMP NOT NULL DEFAULT '2023-02-10T10:00'" and
        ...
        TimeStampOpt[Option[LocalDateTime]](None).DEFAULT(Some(LocalDateTime.of(2023, 2, 10, 10, 0))).queryString === "TIMESTAMP NULL DEFAULT '2023-02-10T10:00'" and
        TimeStampOpt[Option[LocalDateTime]](None).DEFAULT_NULL.queryString === "TIMESTAMP NULL DEFAULT NULL" and
        TimeStampOpt[Option[LocalDateTime]](None).DEFAULT_CURRENT_TIMESTAMP().queryString === "TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP" and
        TimeStampOpt[Option[LocalDateTime]](None).DEFAULT_CURRENT_TIMESTAMP(true).queryString === "TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"
    }
    ...
    "The query string generated from the Time DataType model matches the specified one." in {
      Time[LocalTime](None).queryString === "TIME NOT NULL" and
        ...
        TimeOpt[Option[LocalTime]](None).DEFAULT(Some(LocalTime.of(10, 0, 0))).queryString === "TIME NULL DEFAULT '10:00'" and
