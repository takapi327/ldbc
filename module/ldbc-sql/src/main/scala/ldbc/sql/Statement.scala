...
object Statement:
  ...
  def apply[F[_]: Sync](statement: java.sql.Statement): Statement[F] = new Statement[F]:
    override def executeQuery(sql: String): F[ResultSet[F]] = Sync[F].blocking(statement.executeQuery(sql)).map(ResultSet[F](_))
    ...
    override def getResultSet(): F[ResultSet[F]] = Sync[F].blocking(statement.getResultSet).map(ResultSet[F](_))
    ...
    override def executeUpdate(sql: String, autoGeneratedKeys: Int): F[Int] = Sync[F].blocking(statement.executeUpdate(sql, autoGeneratedKeys))
    override def executeUpdate(sql: String, columnIndexes: Array[Int]): F[Int] = Sync[F].blocking(statement.executeUpdate(sql, columnIndexes))
    override def executeUpdate(sql: String, columnNames: Array[String]): F[Int] = Sync[F].blocking(statement.executeUpdate(sql, columnNames))

    override def execute(sql: String, autoGeneratedKeys: Int): F[Boolean] = Sync[F].blocking(statement.execute(sql, autoGeneratedKeys))
    override def execute(sql: String, columnIndexes: Array[Int]): F[Boolean] = Sync[F].blocking(statement.execute(sql, columnIndexes))
    override def execute(sql: String, columnNames: Array[String]): F[Boolean] = Sync[F].blocking(statement.execute(sql, columnNames))
    ...
    override def executeLargeUpdate(sql: String, autoGeneratedKeys: Int): F[Long] = Sync[F].blocking(statement.executeLargeUpdate(sql, autoGeneratedKeys))
    override def executeLargeUpdate(sql: String, columnIndexes: Array[Int]): F[Long] = Sync[F].blocking(statement.executeLargeUpdate(sql, columnIndexes))
    override def executeLargeUpdate(sql: String, columnNames: Array[String]): F[Long] = Sync[F].blocking(statement.executeLargeUpdate(sql, columnNames))
