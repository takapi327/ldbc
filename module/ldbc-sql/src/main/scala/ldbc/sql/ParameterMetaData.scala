...
object ParameterMetaData:
  ...
  def apply[F[_]: Sync](parameterMetaData: java.sql.ParameterMetaData): ParameterMetaData[F] = new ParameterMetaData[F]:
    ...
    override def isNullable(param: Int): F[Option[Parameter]] = Sync[F].blocking(Parameter.values.find(_.code == parameterMetaData.isNullable(param)))
    ...
    override def getParameterType(param: Int): F[JdbcType] = Sync[F].blocking(JdbcType.fromCode(parameterMetaData.getParameterType(param)))

    override def getParameterTypeName(param: Int): F[String] = Sync[F].blocking(parameterMetaData.getParameterTypeName(param))

    override def getParameterClassName(param: Int): F[String] = Sync[F].blocking(parameterMetaData.getParameterClassName(param))

    override def getParameterMode(param: Int): F[Option[Mode]] = Sync[F].blocking(Mode.values.find(_.code == parameterMetaData.getParameterMode(param)))
