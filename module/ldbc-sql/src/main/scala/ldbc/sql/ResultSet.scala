...
import java.sql.ResultSet as JavaResultSet
import java.sql.Array as JavaSqlArray
import java.sql.{ Ref, Blob, Clob }
...
trait ResultSet[F[_]]:
   ...
   * the new column value
   */
  def updateClob(columnIndex: Int, ref: Blob): F[Unit]
   ...
   * the new column value
   */
  def updateClob(columnLabel: String, ref: Blob): F[Unit]
   ...
   * the first column is 1, the second is 2, ...
   * @return
   * a java.io.Reader object that contains the column value; if the value is SQL NULL, the value returned is null in the Java
   */
   ...
   * the length of the stream
   */
  def updateNCharacterStream(columnIndex: Int, reader: java.io.Reader, length: Long): F[java.io.Reader]
   ...
   * the length of the stream
   */
  def updateNCharacterStream(columnLabel: String, reader: java.io.Reader, length: Long): F[java.io.Reader]
   ...
   * the length of the stream
   */
  def updateAsciiStream(columnIndex: Int, inputStream: java.io.InputStream, length: Long): F[java.io.Reader]
   ...
   * the length of the stream
   */
  def updateAsciiStream(columnLabel: String, inputStream: java.io.InputStream, length: Long): F[java.io.Reader]
   ...
   * the length of the stream
   */
  def updateBinaryStream(columnIndex: Int, inputStream: java.io.InputStream, length: Long): F[java.io.Reader]
   ...
   * the length of the stream
   */
  def updateBinaryStream(columnLabel: String, inputStream: java.io.InputStream, length: Long): F[java.io.Reader]
   ...
   * the length of the stream
   */
  def updateCharacterStream(columnIndex: Int, inputStream: java.io.InputStream, length: Long): F[java.io.Reader]
   ...
   * the length of the stream
   */
  def updateCharacterStream(columnLabel: String, inputStream: java.io.InputStream, length: Long): F[java.io.Reader]
