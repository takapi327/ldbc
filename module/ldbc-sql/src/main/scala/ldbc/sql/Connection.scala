...
trait Connection[F[_]]:
   ...
   *
   * t is strongly recommended that an application explicitly commits or rolls back an active transaction prior to calling the close method. If the close method is called and there is an active transaction, the results are implementation-defined.
   */
  def close(): F[Unit]
   ...
   */
  def createStatement(resultSetType: Int, resultSetConcurrency: Int, resultSetHoldability: Int): F[Statement[F]]
   ...
   */
  def prepareStatement(sql: String, resultSetType: Int, resultSetConcurrency: Int, resultSetHoldability: Int): F[PreparedStatement[F]]
...
object Connection:
  ...
  def apply[F[_]: Sync](connection: java.sql.Connection): Connection[F] = new Connection[F]:
    ...
    override def createStatement(): F[Statement[F]] = Sync[F].blocking(connection.createStatement()).map(Statement[F](_))

    override def prepareStatement(sql: String): F[PreparedStatement[F]] = Sync[F].blocking(connection.prepareStatement(sql)).map(PreparedStatement[F](_))
    ...
    override def setTransactionIsolation(level: Int): F[Unit] = Sync[F].blocking(connection.setTransactionIsolation(level))
    ...
    override def createStatement(resultSetType: Int, resultSetConcurrency: Int): F[Statement[F]] = Sync[F].blocking(connection.createStatement(resultSetType, resultSetConcurrency)).map(Statement[F](_))

    override def prepareStatement(sql: String, resultSetType: Int, resultSetConcurrency: Int): F[PreparedStatement[F]] = Sync[F].blocking(connection.prepareStatement(sql, resultSetType, resultSetConcurrency)).map(PreparedStatement[F](_))
    ...
    override def createStatement(resultSetType: Int, resultSetConcurrency: Int, resultSetHoldability: Int): F[Statement[F]] = Sync[F].blocking(connection.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability)).map(Statement[F](_))

    override def prepareStatement(sql: String, resultSetType: Int, resultSetConcurrency: Int, resultSetHoldability: Int): F[PreparedStatement[F]] = Sync[F].blocking(connection.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability)).map(PreparedStatement[F](_))
    override def prepareStatement(sql: String, autoGeneratedKeys: Int): F[PreparedStatement[F]] = Sync[F].blocking(connection.prepareStatement(sql, autoGeneratedKeys)).map(PreparedStatement[F](_))
    override def prepareStatement(sql: String, columnIndexes: Array[Int]): F[PreparedStatement[F]] = Sync[F].blocking(connection.prepareStatement(sql, columnIndexes)).map(PreparedStatement[F](_))
    override def prepareStatement(sql: String, columnNames: Array[String]): F[PreparedStatement[F]] = Sync[F].blocking(connection.prepareStatement(sql, columnNames)).map(PreparedStatement[F](_))
    ...
    override def setClientInfo(name: String, value: String): F[Unit] = Sync[F].blocking(connection.setClientInfo(name, value))
    ...
    override def createArrayOf(typeName: String, elements: Array[Object]): F[java.sql.Array] = Sync[F].blocking(connection.createArrayOf(typeName, elements))

    override def createStruct(typeName: String, attributes: Array[Object]): F[Struct] = Sync[F].blocking(connection.createStruct(typeName, attributes))
    ...
    override def setNetworkTimeout(executor: Executor, milliseconds: Int): F[Unit] = Sync[F].blocking(connection.setNetworkTimeout(executor, milliseconds))
