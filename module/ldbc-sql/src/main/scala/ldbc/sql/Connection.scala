...
object Connection:
  ...
  def apply[F[_]: Sync](connection: java.sql.Connection): Connection[F] = new Connection[F]:
    ...
    override def createStatement(resultSetType: Int, resultSetConcurrency: Int): F[Statement[F]] =
      Sync[F].blocking(connection.createStatement(resultSetType, resultSetConcurrency)).map(Statement[F](_))
    ...
    override def createStatement(
      ...
      .blocking(connection.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability))
      .map(Statement[F](_))
    ...
    override def prepareStatement(
      ...
      .blocking(connection.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability))
      .map(PreparedStatement[F](_))
