...
object ResultSetMetaData:
  ...
  def apply[F[_]: Sync](resultSetMetaData: java.sql.ResultSetMetaData): ResultSetMetaData[F] = new ResultSetMetaData[F]:
    ...
    override def isNullable(column: Int): F[Option[ColumnNull]] = Sync[F].blocking(ColumnNull.values.find(_.code == resultSetMetaData.isNullable(column)))
    override def isSigned(column: Int): F[Boolean] = Sync[F].blocking(resultSetMetaData.isSigned(column))

    override def getColumnDisplaySize(column: Int): F[Int] = Sync[F].blocking(resultSetMetaData.getColumnDisplaySize(column))
    ...
    override def getColumnType(column: Int): F[JdbcType] = Sync[F].blocking(JdbcType.fromCode(resultSetMetaData.getColumnType(column)))
    override def getColumnTypeName(column: Int): F[String] = Sync[F].blocking(resultSetMetaData.getColumnTypeName(column))
    ...
    override def isDefinitelyWritable(column: Int): F[Boolean] = Sync[F].blocking(resultSetMetaData.isDefinitelyWritable(column))
    override def getColumnClassName(column: Int): F[String] = Sync[F].blocking(resultSetMetaData.getColumnClassName(column))
