...
class NativeDataTypeTest extends DataTypeTest:
  ...
  test("The query string generated from the Float DataType model matches the specified one.") {
    ...
    assertEquals(FLOAT[Float](0).DEFAULT(1.2f).queryString, "FLOAT(0) NOT NULL DEFAULT 1.2")
    ...
    assertEquals(FLOAT[Option[Float]](0).DEFAULT(Some(1.2f)).queryString, "FLOAT(0) NULL DEFAULT 1.2")
  }
