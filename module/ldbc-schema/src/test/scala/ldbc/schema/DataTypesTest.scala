...
class DataTypesTest extends munit.FunSuite:
  ...
  test("If the length at the time of BIT generation is greater than 64, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of TINYINT generation is greater than 255, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of SMALLINT generation is greater than 255, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of MEDIUMINT generation is greater than 255, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of INT generation is greater than 255, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of BIGINT generation is greater than 255, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the accuracy at the time of DECIMAL generation is greater than 65, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If scale is lower than 0 at the time of DECIMAL generation, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the accuracy at the time of FLOAT generation is greater than 24, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the accuracy at the time of DOUBLE generation is greater than 53, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of CHAR generation is greater than 255, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of VARCHAR generation is greater than 255, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of BINARY generation is greater than 255, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
  ...
  test("If the length at the time of BLOB generation is greater than 4294967295L, an error occurs.") {
    assert(compileErrors("""
      import ldbc.schema.*
      import ldbc.schema.DataType.*
