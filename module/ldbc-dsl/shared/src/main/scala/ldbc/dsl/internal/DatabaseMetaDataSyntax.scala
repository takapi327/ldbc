  ...
  implicit class DatabaseMetaDataF(metaDataObject: DatabaseMetaData.type):
    ...
    def apply[F[_]: Sync](metaData: java.sql.DatabaseMetaData): DatabaseMetaData[F] =
      new DatabaseMetaData[F]:
        ...
        override def supportsTransactionIsolationLevel(level: Int): Boolean = metaData.supportsTransactionIsolationLevel(level)
        override def supportsDataDefinitionAndDataManipulationTransactions(): Boolean = metaData.supportsDataDefinitionAndDataManipulationTransactions
        override def supportsDataManipulationTransactionsOnly(): Boolean = metaData.supportsDataManipulationTransactionsOnly
        ...
        override def getProcedures(
          ...
          Sync[F].blocking(metaData.getProcedures(
            catalog.orNull,
        ...
        override def getProcedureColumns(
          ...
          Sync[F].blocking(metaData.getProcedureColumns(
            catalog.orNull,
            schemaPattern.orNull,
            procedureNamePattern.orNull,
        ...
        override def getTables(
          ...
          Sync[F].blocking(metaData.getTables(
            catalog.orNull,
            schemaPattern.orNull,
        ...
        override def getSchemas(): F[ResultSet[F]] = Sync[F].blocking(metaData.getSchemas()).map(ResultSet[F])
        override def getCatalogs(): F[ResultSet[F]] = Sync[F].blocking(metaData.getCatalogs).map(ResultSet[F])
        override def getTableTypes(): F[ResultSet[F]] = Sync[F].blocking(metaData.getTableTypes).map(ResultSet[F])
        override def getColumns(
          ...
          Sync[F].blocking(metaData.getColumns(catalog.orNull, schemaPattern.orNull, tableName.orNull, columnNamePattern.orNull)).map(ResultSet[F])
        override def getColumnPrivileges(
          ...
          Sync[F].blocking(metaData.getColumnPrivileges(catalog.orNull, schema.orNull, table.orNull, columnNamePattern.orNull)).map(ResultSet[F])
        ...
        override def getTablePrivileges(
          ...
          Sync[F].blocking(metaData.getTablePrivileges(catalog.orNull, schemaPattern.orNull, tableNamePattern.orNull)).map(ResultSet[F])
        override def getBestRowIdentifier(
          ...
          Sync[F].blocking(metaData.getBestRowIdentifier(catalog.orNull, schema.orNull, table, scope.getOrElse(0), nullable.getOrElse(false))).map(ResultSet[F])
        override def getVersionColumns(catalog: Option[String], schema: Option[String], table: String): F[ResultSet[F]] =
          Sync[F].blocking(metaData.getVersionColumns(catalog.orNull, schema.orNull, table)).map(ResultSet[F])
        override def getPrimaryKeys(catalog: Option[String], schema: Option[String], table: String): F[ResultSet[F]] =
          Sync[F].blocking(metaData.getPrimaryKeys(catalog.orNull, schema.orNull, table)).map(ResultSet[F])
        override def getImportedKeys(catalog: Option[String], schema: Option[String], table: String): F[ResultSet[F]] =
          Sync[F].blocking(metaData.getImportedKeys(catalog.orNull, schema.orNull, table)).map(ResultSet[F])
        override def getExportedKeys(catalog: Option[String], schema: Option[String], table: String): F[ResultSet[F]] =
          Sync[F].blocking(metaData.getExportedKeys(catalog.orNull, schema.orNull, table)).map(ResultSet[F])
        override def getCrossReference(
          ...
          Sync[F].blocking(metaData.getCrossReference(
        ...
        override def getTypeInfo(): F[ResultSet[F]] = Sync[F].blocking(metaData.getTypeInfo).map(ResultSet[F])
        override def getIndexInfo(
          ...
          Sync[F].blocking(metaData.getIndexInfo(
            catalog.orNull,
            schema.orNull,
            table.orNull,
            unique,
        ...
        override def supportsResultSetConcurrency(`type`: Int, concurrency: Int): Boolean = metaData.supportsResultSetConcurrency(`type`, concurrency)
        ...
        override def getUDTs(
          ...
          Sync[F].blocking(metaData.getUDTs(
            catalog.orNull,
            schemaPattern.orNull,
        ...
        override def getConnection(): Connection[F] = Connection[F](metaData.getConnection)
        ...
        override def getSuperTypes(
          ...
          Sync[F].blocking(metaData.getSuperTypes(
            catalog.orNull,
            schemaPattern.orNull,
            typeNamePattern.orNull
          )).map(ResultSet[F])
        ...
        override def getSuperTables(
          ...
          Sync[F].blocking(metaData.getSuperTables(
            catalog.orNull,
            schemaPattern.orNull,
            tableNamePattern.orNull
          )).map(ResultSet[F])
        ...
        override def getAttributes(
          ...
          Sync[F].blocking(metaData.getAttributes(catalog.orNull, schemaPattern.orNull, typeNamePattern.orNull, attributeNamePattern.orNull)).map(ResultSet[F])
        override def supportsResultSetHoldability(holdability: Int): Boolean = metaData.supportsResultSetHoldability(holdability)
        ...
        override def getSchemas(catalog: Option[String], schemaPattern: Option[String]): F[ResultSet[F]] =
          Sync[F].blocking(metaData.getSchemas(catalog.orNull, schemaPattern.orNull)).map(ResultSet[F])
        ...
        override def getClientInfoProperties(): F[ResultSet[F]] = Sync[F].blocking(metaData.getClientInfoProperties).map(ResultSet[F])
        ...
        override def getFunctions(
          ...
          Sync[F].blocking(metaData.getFunctions(
            catalog.orNull,
            schemaPattern.orNull,
        ...
        override def getFunctionColumns(
          ...
          Sync[F].blocking(metaData.getFunctionColumns(
            catalog.orNull,
            schemaPattern.orNull,
            functionNamePattern.orNull,
            columnNamePattern.orNull
        ...
        override def getPseudoColumns(
          ...
          Sync[F].blocking(metaData.getPseudoColumns(
            catalog.orNull,
            schemaPattern.orNull,
            tableNamePattern.orNull,
            columnNamePattern.orNull
