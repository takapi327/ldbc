...
object ResultSetIO:
  ...
  def getTimestamp(columnLabel: String): ResultSetIO[LocalDateTime] = Free.liftF(ResultSetOp.GetTimestampByLabel(columnLabel))
  ...
  def getBigDecimal(columnLabel: String): ResultSetIO[BigDecimal] = Free.liftF(ResultSetOp.GetBigDecimalByLabel(columnLabel))
