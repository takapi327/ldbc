...
object Codec extends TwiddleSyntax[Codec]:
  ...
  private def readCatchError[A](offset: Int, func: => A): Either[Decoder.Error, A] =
    try Right(func)
      ...
      case ex: Throwable => Left(Decoder.Error(offset, ex.getMessage, Some(ex)))
  ...
  given Codec[Boolean] with
    ...
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, Boolean]         = readCatchError(offset, resultSet.getBoolean(index))

  given Codec[Byte] with
    override def offset:                                   Int             = 1
    override def encode(value:     Byte):                  Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, Byte]            = readCatchError(offset, resultSet.getByte(index))

  given Codec[Short] with
    override def offset:                                   Int             = 1
    override def encode(value:     Short):                 Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, Short]           = readCatchError(offset, resultSet.getShort(index))

  given Codec[Int] with
    override def offset:                                   Int             = 1
    override def encode(value:     Int):                   Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, Int]             = readCatchError(offset, resultSet.getInt(index))

  given Codec[Long] with
    override def offset:                                   Int             = 1
    override def encode(value:     Long):                  Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, Long]            = readCatchError(offset, resultSet.getLong(index))

  given Codec[Float] with
    override def offset:                                   Int             = 1
    override def encode(value:     Float):                 Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, Float]           = readCatchError(offset, resultSet.getFloat(index))

  given Codec[Double] with
    override def offset:                                   Int             = 1
    override def encode(value:     Double):                Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, Double]          = readCatchError(offset, resultSet.getDouble(index))

  given Codec[BigDecimal] with
    override def offset:                                   Int             = 1
    override def encode(value:     BigDecimal):            Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, BigDecimal]      = readCatchError(offset, resultSet.getBigDecimal(index))

  given Codec[String] with
    override def offset:                                   Int             = 1
    override def encode(value:     String):                Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, String]          = readCatchError(offset, resultSet.getString(index))

  given Codec[Array[Byte]] with
    override def offset:                                   Int             = 1
    override def encode(value:     Array[Byte]):           Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, Array[Byte]]     = readCatchError(offset, resultSet.getBytes(index))

  given Codec[LocalTime] with
    override def offset:                                   Int             = 1
    override def encode(value:     LocalTime):             Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, LocalTime]       = readCatchError(offset, resultSet.getTime(index))

  given Codec[LocalDate] with
    override def offset:                                   Int             = 1
    override def encode(value:     LocalDate):             Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, LocalDate]       = readCatchError(offset, resultSet.getDate(index))

  given Codec[LocalDateTime] with
    override def offset:                                   Int             = 1
    override def encode(value:     LocalDateTime):         Encoder.Encoded = Encoder.Encoded.success(List(value))
    override def decode(resultSet: ResultSet, index: Int): Either[Decoder.Error, LocalDateTime]   = readCatchError(offset, resultSet.getTimestamp(index))
