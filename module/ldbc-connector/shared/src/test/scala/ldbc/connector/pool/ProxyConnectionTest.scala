    ...
    connection.use { conn =>
      for
        ...
        mockStmt = new Statement[IO] {
                     ...
                     override def enquoteLiteral(value: String): IO[String]      = IO.pure(value)
                     override def enquoteIdentifier(identifier: String, alwaysQuote: Boolean): IO[String] =
                       IO.pure(identifier)
                     override def enquoteNCharLiteral(value:     String): IO[String]  = IO.pure(value)
                     override def isSimpleIdentifier(identifier: String): IO[Boolean] = IO.pure(false)
                   }
