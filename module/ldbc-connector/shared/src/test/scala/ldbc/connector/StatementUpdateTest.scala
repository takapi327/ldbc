    ...
    assertIO(
      connection.use { conn =>
        ...
        for
          ...
          _ <- statement
                 .executeUpdate("INSERT INTO `auto_inc_table`(`id`, `c1`) VALUES (null, 'column 1')")
                 .executeUpdate()
          generated <-
            statement.returningAutoGeneratedKey("INSERT INTO `auto_inc_table`(`id`, `c1`) VALUES (null, 'column 2')")
