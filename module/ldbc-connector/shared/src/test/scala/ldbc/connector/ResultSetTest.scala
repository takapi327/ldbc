...
class ResultSetTest extends CatsEffectSuite:
  ...
  test("ResultSet should return the correct value for getInt") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_LONG), column("c2", ColumnDataType.MYSQL_TYPE_LONG), column("c3", ColumnDataType.MYSQL_TYPE_LONG)), Vector(ResultSetRowPacket(List(Some("1"), Some("2"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getLong") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_LONGLONG), column("c2", ColumnDataType.MYSQL_TYPE_LONGLONG), column("c3", ColumnDataType.MYSQL_TYPE_LONGLONG)), Vector(ResultSetRowPacket(List(Some("1"), Some("2"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getDouble") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_DOUBLE), column("c2", ColumnDataType.MYSQL_TYPE_DOUBLE), column("c3", ColumnDataType.MYSQL_TYPE_DOUBLE)), Vector(ResultSetRowPacket(List(Some("1.1"), Some("2.2"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getString") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_STRING), column("c2", ColumnDataType.MYSQL_TYPE_STRING), column("c3", ColumnDataType.MYSQL_TYPE_STRING)), Vector(ResultSetRowPacket(List(Some("1"), Some("2"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getBoolean") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_TINY), column("c2", ColumnDataType.MYSQL_TYPE_TINY), column("c3", ColumnDataType.MYSQL_TYPE_TINY)), Vector(ResultSetRowPacket(List(Some("1"), Some("0"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getByte") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_TINY), column("c2", ColumnDataType.MYSQL_TYPE_TINY), column("c3", ColumnDataType.MYSQL_TYPE_TINY)), Vector(ResultSetRowPacket(List(Some("1"), Some("2"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getShort") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_SHORT), column("c2", ColumnDataType.MYSQL_TYPE_SHORT), column("c3", ColumnDataType.MYSQL_TYPE_SHORT)), Vector(ResultSetRowPacket(List(Some("1"), Some("2"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getFloat") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_FLOAT), column("c2", ColumnDataType.MYSQL_TYPE_FLOAT), column("c3", ColumnDataType.MYSQL_TYPE_FLOAT)), Vector(ResultSetRowPacket(List(Some("1.1"), Some("2.2"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getBigDecimal") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_DECIMAL), column("c2", ColumnDataType.MYSQL_TYPE_DECIMAL), column("c3", ColumnDataType.MYSQL_TYPE_DECIMAL)), Vector(ResultSetRowPacket(List(Some("1.1"), Some("2.2"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getDate") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_DATE), column("c2", ColumnDataType.MYSQL_TYPE_DATE), column("c3", ColumnDataType.MYSQL_TYPE_DATE)), Vector(ResultSetRowPacket(List(Some("2023-01-01"), Some("2023-01-02"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getTime") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_TIME), column("c2", ColumnDataType.MYSQL_TYPE_TIME), column("c3", ColumnDataType.MYSQL_TYPE_TIME)), Vector(ResultSetRowPacket(List(Some("12:34:56"), Some("12:34:57"), None))), Version(0, 0, 0))
  ...
  test("ResultSet should return the correct value for getTimestamp") {
    val resultSet = ResultSet(Vector(column("c1", ColumnDataType.MYSQL_TYPE_TIMESTAMP), column("c2", ColumnDataType.MYSQL_TYPE_TIMESTAMP), column("c3", ColumnDataType.MYSQL_TYPE_TIMESTAMP)), Vector(ResultSetRowPacket(List(Some("2023-01-01 12:34:56"), Some("2023-01-02 12:34:57"), None))), Version(0, 0, 0))
    ...
    assertEquals(records.result(), List((Some(LocalDateTime.of(2023, 1, 1, 12, 34, 56)), Some(LocalDateTime.of(2023, 1, 2, 12, 34, 57)), None)))
  }
  ...
  test("Multiple records can be retrieved by looping through them with next.") {
    val resultSet = ResultSet(
      Vector(column("c1", ColumnDataType.MYSQL_TYPE_LONG), column("c2", ColumnDataType.MYSQL_TYPE_LONG), column("c3", ColumnDataType.MYSQL_TYPE_LONG)),
      Vector(
