...
case class CallableStatementImpl[F[_]: Temporal: Exchange: Tracer](
  ...
  extends CallableStatement[F], SharedPreparedStatement[F]:
  ...
  private def mangleParameterName(origParameterName: String): String =
    ...
    val paramNameBuf = new StringBuilder(CallableStatementImpl.PARAMETER_NAMESPACE_PREFIX.length + origParameterName.length)
