...
trait Connection[F[_]]:
   ...
   */
  def prepareStatement(sql: String, autoGeneratedKeys: Statement.NO_GENERATED_KEYS | Statement.RETURN_GENERATED_KEYS): F[PreparedStatement[F]]
   ...
   *         returning auto-generated keys
   */
  def clientPreparedStatement(sql: String, autoGeneratedKeys: Statement.NO_GENERATED_KEYS | Statement.RETURN_GENERATED_KEYS): F[PreparedStatement.Client[F]]
   ...
   *         returning auto-generated keys
   */
  def serverPreparedStatement(sql: String, autoGeneratedKeys: Statement.NO_GENERATED_KEYS | Statement.RETURN_GENERATED_KEYS): F[PreparedStatement.Server[F]]
...
object Connection:
  ...
  private[ldbc] case class ConnectionImpl[F[_]: Temporal: Tracer: Console: Exchange](
    ...
    override def prepareStatement(sql: String, autoGeneratedKeys: NO_GENERATED_KEYS | RETURN_GENERATED_KEYS): F[PreparedStatement[F]] =
      for
        params <- Ref[F].of(ListMap.empty[Int, Parameter])
        batchedArgs <- Ref[F].of(Vector.empty[String])
        currentResultSet <- Ref[F].of[Option[ResultSet[F]]](None)
        ...
        moreResults <- Ref[F].of(false)
        autoGeneratedKeys <-
          Ref[F].of[Statement.NO_GENERATED_KEYS | Statement.RETURN_GENERATED_KEYS](autoGeneratedKeys)
        lastInsertId <- Ref[F].of(0)
      yield PreparedStatement.Client[F](
        protocol,
        serverVariables,
    ...
    override def clientPreparedStatement(sql: String, autoGeneratedKeys: NO_GENERATED_KEYS | RETURN_GENERATED_KEYS): F[PreparedStatement.Client[F]] =
      for
        params <- Ref[F].of(ListMap.empty[Int, Parameter])
        batchedArgs <- Ref[F].of(Vector.empty[String])
        currentResultSet <- Ref[F].of[Option[ResultSet[F]]](None)
    ...
    override def serverPreparedStatement(sql: String, autoGeneratedKeys: NO_GENERATED_KEYS | RETURN_GENERATED_KEYS): F[PreparedStatement.Server[F]] =
      for
        result <- protocol.resetSequenceId *> protocol.send(ComStmtPreparePacket(sql)) *>
          protocol.receive(ComStmtPrepareOkPacket.decoder(protocol.initialPacket.capabilityFlags)).flatMap {
            case error: ERRPacket => ev.raiseError(error.toException("Failed to execute query", sql))
