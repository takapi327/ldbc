  ...
  "Testing the DataTypeCodeBuilder" should {
    ...
    "CHAR DataType construction to code string matches the specified string." in {
      ...
      builder("String").build(
        dataType1
      ) === "CHAR[String](255).CHARACTER_SET(Character.utf8mb4).COLLATE(Collate.utf8mb4_bin)" and
    ...
    "VARCHAR DataType construction to code string matches the specified string." in {
      ...
      builder("String").build(
        ...
        builder("Option[String]").build(
          dataType2
        ) === "VARCHAR[Option[String]](255).CHARACTER_SET(Character.utf8mb4)" and
    ...
    "ENUM DataType construction to code string matches the specified string." in {
      ...
      builder("Status").build(
        ...
        builder("Option[Status]").build(
          dataType3
        ) === "ENUM[Option[Status]](using Status).COLLATE(Collate.utf8mb4_bin)" and
    ...
    "TEXT DataType construction to code string matches the specified string." in {
      ...
      builder("String").build(
        dataType1
      ) === "TEXT[String]().CHARACTER_SET(Character.utf8mb4).COLLATE(Collate.utf8mb4_bin)" and
        builder("Option[String]").build(
          dataType1
    ...
    "MEDIUMTEXT DataType construction to code string matches the specified string." in {
      ...
      builder("String").build(
        ...
        builder("Option[String]").build(
          dataType2
        ) === "MEDIUMTEXT[Option[String]]().CHARACTER_SET(Character.utf8mb4)" and
