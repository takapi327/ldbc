...
import ldbc.dsl.*
import ldbc.dsl.codec.{ Codec, Encoder, Decoder }
...
class WhereTest extends AnyFlatSpec:
  ...
  def createQuery[B](statement: String, params: List[Parameter.Dynamic])(using Decoder[B], Encoder[B]): Where.Q[TestTable, B] =
