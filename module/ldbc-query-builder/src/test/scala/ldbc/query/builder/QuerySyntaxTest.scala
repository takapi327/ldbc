...
class QuerySyntaxTest extends munit.FunSuite:

  test("It can be converted to the model specified by the toList method.") {
  ...
  test("If the Tuple generated by the toList method does not match the type of the specified model property, a Compile error occurs.") {
  ...
  test("The type of Tuple generated by the toList method matches the specified type.") {
    assertEquals(compileErrors("""
  ...
  test("It can be converted to the model specified by the headOption method.") {
    assertEquals(compileErrors("""
      import ldbc.dsl.codec.Codec
      import ldbc.query.builder.*
  ...
  test("If the Tuple generated by the headOption method does not match the type of the specified model property, a Compile error occurs.") {
    assert(compileErrors("""
      import ldbc.dsl.codec.Codec
      import ldbc.query.builder.*
  ...
  test("The type of Tuple generated by the headOption method matches the specified type.") {
    assertEquals(compileErrors("""
      import cats.effect.IO
      import ldbc.dsl.DBIO
      import ldbc.dsl.codec.Codec
  ...
  test("It can be converted to the model specified by the unsafe method.") {
    assertEquals(compileErrors("""
      import cats.effect.IO
      import ldbc.dsl.DBIO
      import ldbc.dsl.codec.Codec
  ...
  test("If the Tuple generated by the unsafe method does not match the type of the specified model property, a Compile error occurs.") {
    assert(compileErrors("""
      import ldbc.dsl.codec.Codec
      import ldbc.query.builder.*
  ...
  test("The type of Tuple generated by the unsafe method matches the specified type.") {
    assertEquals(compileErrors("""
      import cats.effect.IO
      import ldbc.dsl.DBIO
      import ldbc.dsl.codec.Codec
  ...
  test("The type of the Tuple generated by the Join matches the specified type.") {
    assertEquals(compileErrors("""
      import cats.effect.IO
      import ldbc.dsl.DBIO
      import ldbc.dsl.codec.Codec
  ...
  test("The type generated by the join matches the type of the specified model.") {
    assertEquals(compileErrors("""
      import cats.effect.IO
  ...
  test("The type of Tuple generated by Left Join matches the specified type.") {
    assertEquals(compileErrors("""
      import cats.effect.IO
  ...
  test("The type of Tuple generated by Right Join matches the specified type.") {
    assertEquals(compileErrors("""
      import cats.effect.IO
  ...
  test("When a column of type Option is made into type Option with Right Join, Option is not nested.") {
    assertEquals(compileErrors("""
      import cats.effect.IO
