...
class QuerySyntaxTest extends munit.FunSuite:
  ...
  test(
    "If the Tuple generated by the toList method does not match the type of the specified model property, a Compile error occurs."
  ) {
  ...
  test(
    "If the Tuple generated by the headOption method does not match the type of the specified model property, a Compile error occurs."
  ) {
    assert(compileErrors("""
      import ldbc.dsl.codec.Codec
      import ldbc.query.builder.*
  ...
  test(
    "If the Tuple generated by the unsafe method does not match the type of the specified model property, a Compile error occurs."
  ) {
    assert(compileErrors("""
      import ldbc.dsl.codec.Codec
      import ldbc.query.builder.*
