...
trait Join[F[_], JOINS <: Tuple, SELECTS <: Tuple]:
   ...
   */
  def join[P <: Product](other: TableQuery[F, P])(on: Tuple.Concat[JOINS, Tuple1[TableQuery[F, P]]] => ExpressionSyntax[F]): Join[F, Tuple.Concat[JOINS, Tuple1[TableQuery[F, P]]], Tuple.Concat[SELECTS, Tuple1[TableQuery[F, P]]]] =
    val joinTable: TableQuery[F, P] = TableQuery(other.table.alias.fold(other.table.as(other.table._name))(_ => other.table))
    Join(
      main,
   ...
   * Base trait for all products
   */
  def leftJoin[P <: Product](other: TableQuery[F, P])(on: Tuple.Concat[JOINS, Tuple1[TableQuery[F, P]]] => ExpressionSyntax[F]): Join[F, Tuple.Concat[JOINS, Tuple1[TableQuery[F, P]]], Tuple.Concat[SELECTS, Tuple1[TableOpt[F, P]]]] =
    val joinTable: TableQuery[F, P] = TableQuery(other.table.alias.fold(other.table.as(other.table._name))(_ => other.table))
    Join(
      main,
      joins ++ Tuple(joinTable),
   ...
   * Base trait for all products
   */
  def rightJoin[P <: Product](other: TableQuery[F, P])(on: Tuple.Concat[JOINS, Tuple1[TableQuery[F, P]]] => ExpressionSyntax[F]): Join[F, Tuple.Concat[JOINS, Tuple1[TableQuery[F, P]]], Tuple.Concat[SELECTS, Tuple1[TableQuery[F, P]]]] =
    val joinTable: TableQuery[F, P] = TableQuery(other.table.alias.fold(other.table.as(other.table._name))(_ => other.table))
    Join(
      main,
      joins ++ Tuple(joinTable),
...
object Join:
  ...
  ) extends Query[F, T], JoinOrderByProvider[F, SELECTS, T], LimitProvider[F, T]:
