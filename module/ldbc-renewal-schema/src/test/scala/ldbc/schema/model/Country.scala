...
class CountryTable extends Table[Country]("country"):
  ...
  override def * : Column[Country] = (code *: name *: continent *: region *: surfaceArea *: indepYear *: population *: lifeExpectancy *: gnp *: gnpOld *: localName *: governmentForm *: headOfState *: capital *: code2).to[Country]
