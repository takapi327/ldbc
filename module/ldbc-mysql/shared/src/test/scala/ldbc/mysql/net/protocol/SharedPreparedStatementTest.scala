...
class SharedPreparedStatementTest extends SharedPreparedStatement[Fx], FTestPlatform:
  ...
  override val params:          Ref[Fx, SortedMap[Int, Parameter]] = Ref.unsafe[Fx, SortedMap[Int, Parameter]](parameterMap)
  override val databaseMetrics: DatabaseMetrics[Fx]           = DatabaseMetrics.noop[Fx]
  ...
  override def fetchSize:          Ref[Fx, Int]            = Ref.unsafe[Fx, Int](0)
