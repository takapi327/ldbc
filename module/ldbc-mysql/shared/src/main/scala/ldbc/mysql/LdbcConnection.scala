 ...
 *   the effect type
 */
trait LdbcConnection extends Connection[Fx]:
   ...
   */
  def clientPreparedStatement(sql: String): Fx[ClientPreparedStatement]
   ...
   *   SQL queries based on text protocols
   */
  def serverPreparedStatement(sql: String): Fx[ServerPreparedStatement]
   ...
   */
  def getStatistics: Fx[StatisticsPacket]

  /**
   * Resets the server-side state of this connection. 
   */
  def resetServerState: Fx[Unit]
