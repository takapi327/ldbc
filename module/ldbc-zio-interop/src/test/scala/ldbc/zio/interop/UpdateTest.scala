    ...
    test("Boolean values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_boolean_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("Byte values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_byte_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("Short values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_short_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("Int values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_int_table`(`c1`, `c2`) VALUES (?, ?)")
          count <-
    ...
    test("Long values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_long_table`(`c1`, `c2`) VALUES (?, ?)")
          count <-
    ...
    test("BigInt values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_bigint_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("Float values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_float_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("Double values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_double_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("BigDecimal values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_bigdecimal_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("String values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_string_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("Array[Byte] values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_bytes_table`(`c1`, `c2`) VALUES (?, ?)")
          count <-
    ...
    test("java.time.LocalTime values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_time_table`(`c1`, `c2`) VALUES (?, ?)")
          count <-
    ...
    test("java.time.LocalDate values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_date_table`(`c1`, `c2`) VALUES (?, ?)")
          count <-
    ...
    test("java.time.LocalDateTime values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_datetime_table`(`c1`, `c2`) VALUES (?, ?)")
    ...
    test("java.time.Year values can be set as parameters") {
      datasource.getConnection.use { conn =>
        for
          ...
          preparedStatement <-
            conn.prepareStatement("INSERT INTO `client_statement_year_table`(`c1`, `c2`) VALUES (?, ?)")
          count <-
