...
trait TableQuerySelectConnectionTest extends CatsEffectSuite:
  ...
  private val country          = TableQuery[Country]("country")
  private val city             = TableQuery[City]("city")
  private val countryLanguage  = TableQuery[CountryLanguage]("countrylanguage")
  private val governmentOffice = TableQuery[GovernmentOffice]("government_office")
