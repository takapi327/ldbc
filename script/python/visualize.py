...
target_names = {
    'jdbc_statement': 'jdbc: statement',
    'jdbc_prepareStatement': 'jdbc: prepareStatement',
    'ldbc_statement': 'ldbc: statement',
    'ldbc_prepareStatement': 'ldbc: prepareStatement',
    'zio_statement': 'ZIO: statement',
    'zio_prepareStatement': 'ZIO: prepareStatement',
    'cats_effect_statement': 'Cats Effect: statement',
    'cats_effect_prepareStatement': 'Cats Effect: prepareStatement',
