...
class PoolLoggerTest extends FxSuite:
  ...
  test("PoolLogger should log pool state when debug is enabled") {
    val logger = PoolLogger.console[Fx](logDebug = true)
  ...
  test("PoolLogger should not log when debug is disabled") {
    val logger = PoolLogger.console[Fx](logDebug = false)
  ...
  test("PoolLogger should not perform any operations") {
    val logger = PoolLogger.noop[Fx]
  ...
  test("PoolLogger should format pool state correctly") {
    val logger = PoolLogger.console[Fx](logDebug = true)
  ...
  test("PoolLogger[Fx] should handle all log levels") {
    val logger = PoolLogger.console[Fx](logDebug = true)
