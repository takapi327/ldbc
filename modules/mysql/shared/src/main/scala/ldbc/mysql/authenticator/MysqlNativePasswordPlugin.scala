 ...
 */
class MysqlNativePasswordPlugin[F[_]](using F: Sync[F]) extends AuthenticationPlugin[F]:
...
object MysqlNativePasswordPlugin:
  def apply[F[_]](using F: Sync[F]): MysqlNativePasswordPlugin[F] = new MysqlNativePasswordPlugin[F]()
