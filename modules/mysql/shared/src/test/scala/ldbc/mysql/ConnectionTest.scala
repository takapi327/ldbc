...
class ConnectionTest extends FTestPlatform:
  ...
  test("Passing an empty string to host causes SQLException") {
    ...
    interceptFx[SQLClientInfoException] {
      connection.use(_ => Fx.unit)
    }
  }
  ...
  test("Connections to MySQL servers using users with sha256_password will fail for non-SSL connections.") {
    ...
    interceptFx[SQLInvalidAuthorizationSpecException] {
      connection.use(_ => Fx.unit)
    }
  }
  ...
  test("The connection is valid.") {
    ...
    assertFxBoolean(connection.use(_.isValid(0)))
  }
  ...
  test("Connection state reset succeeds.") {
    ...
    assertFxBoolean(connection.use(_.resetServerState) *> Fx.delay(true))
  }
  ...
  test("If multi-querying is not enabled, ERRPacketException is raised when multi-querying is performed.") {
    ...
    interceptFx[SQLSyntaxErrorException](connection.use { conn =>
      for
  ...
  test("The allProceduresAreCallable method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.allProceduresAreCallable())))
  }
  ...
  test("The allTablesAreSelectable method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.allTablesAreSelectable())))
  }
  ...
  test("The isReadOnly method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.isReadOnly())))
  }
  ...
  test("The nullsAreSortedHigh method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.nullsAreSortedHigh())))
  }
  ...
  test("The nullsAreSortedLow method of DatabaseMetaData is always true.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => meta.nullsAreSortedLow())))
  }
  ...
  test("The nullsAreSortedAtStart method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.nullsAreSortedAtStart())))
  }
  ...
  test("The nullsAreSortedAtEnd method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.nullsAreSortedAtEnd())))
  }
  ...
  test("The usesLocalFiles method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.usesLocalFiles())))
  }
  ...
  test("The usesLocalFilePerTable method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.usesLocalFilePerTable())))
  }
  ...
  test("The supports Mixed Case Identifiers retrieved from DatabaseMetaData matches the specified value.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(_.supportsMixedCaseIdentifiers())))
  }
  ...
  test("The storesUpperCaseIdentifiers method of DatabaseMetaData is always false.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.storesUpperCaseIdentifiers())))
  }
  ...
  test("The stores Lower Case Identifiers retrieved from DatabaseMetaData matches the specified value.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.storesLowerCaseIdentifiers())))
  }
  ...
  test("The stores Mixed Case Identifiers retrieved from DatabaseMetaData matches the specified value.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(_.storesMixedCaseIdentifiers())))
  }
  ...
  test("The supports Mixed Case Quoted Identifiers retrieved from DatabaseMetaData matches the specified value.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(_.supportsMixedCaseQuotedIdentifiers())))
  }
  ...
  test("The storesUpperCaseQuotedIdentifiers method of DatabaseMetaData is always true.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.storesUpperCaseQuotedIdentifiers())))
  }
  ...
  test("The stores Lower Case Quoted Identifiers retrieved from DatabaseMetaData matches the specified value.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(meta => !meta.storesLowerCaseQuotedIdentifiers())))
  }
  ...
  test("The stores Mixed Case Quoted Identifiers retrieved from DatabaseMetaData matches the specified value.") {
    ...
    assertFxBoolean(connection.use(_.getMetaData().map(_.storesMixedCaseQuotedIdentifiers())))
  }
    ...
    assertFx(
      connection.use { conn =>
        for
          ...
          result    <-
            resultSet.whileM[Vector, String] {
              for
    ...
    assertFx(
      connection.use { conn =>
        for
          ...
          result    <- resultSet.whileM[Vector, Option[String]] {
                      for
        ...
        for
          ...
          result    <- resultSet.whileM[Vector, Option[String]] {
                      resultSet.getString("TABLE_CAT").map { tableCatalog =>
                        // codec_test and connector_before_after_test are excluded because they are created and deleted in other tests, causing unintended test failures when tests are run in parallel.
                        if tableCatalog == "codec_test" || tableCatalog == "connector_before_after_test" then None
                        else Some(s"Table Catalog: $tableCatalog")
                      }
                    }
        yield result.flatten
      },
    ...
    assertFx(
      connection.use { conn =>
        for
          ...
          result    <- resultSet.whileM[Vector, String] {
  ...
  test("Arbitrary processing can be performed before and after the connection.") {
    def before(connection: ldbc.sql.Connection[Fx]): Fx[Int] =
      for
    ...
    def after(connection: ldbc.sql.Connection[Fx]): Fx[Unit] =
      for
        statement <- connection.createStatement()
        _         <- statement.execute("DROP DATABASE IF EXISTS connector_before_after_test")
      yield ()

    val connection = Connection.withBeforeAfter[Fx, Int](
      host     = TestConfig.host,
      port     = TestConfig.port,
      user     = TestConfig.user,
      password = Some(TestConfig.password),
