...
class Insert:
  ...
  @volatile
  var records: List[(Short, Int, Int, Int, Long, Float, Double, BigDecimal, String, String, Boolean, LocalDate, LocalTime, LocalDateTime, LocalDateTime)] = List.empty
  ...
  def setup(): Unit =
    ...
    records = (1 to len).map(num => (1.toShort, 1, 1, 1, 1L, 1.1f, 1.1, BigDecimal.decimal(1.1), s"varchar $num", s"text $num", true, LocalDate.now(), LocalTime.now(), LocalDateTime.now(), LocalDateTime.now())).toList
    ...
    connection
      .use { conn =>
        for
          ...
          _ <- statement.executeUpdate(s"INSERT INTO ldbc_statement_test (c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15) VALUES ${records.map { case (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) => s"($v1, $v2, $v3, $v4, $v5, $v6, $v7, $v8, '$v9', '$v10', $v11, '$v12', '$v13', '${v14.toString.replace("T", " ")}', '${v15.toString.replace("T", " ")}')" }.mkString(",")}")
        yield ()
      }
      .unsafeRunSync()
  ...
  def prepareStatement(): Unit =
    connection
      .use { conn =>
        for
          statement <- conn.prepareStatement(s"INSERT INTO ldbc_prepare_statement_test (c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15) VALUES $values")
